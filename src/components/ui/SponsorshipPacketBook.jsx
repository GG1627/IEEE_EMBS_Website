    ...
    <div className="relative w-full h-full flex flex-col items-center overflow-hidden">
      ...
      <div className="relative flex items-center justify-center w-full mt-4">
        ...
        <a
          ...
          className="absolute right-0 inline-flex items-center gap-1.5 px-3 py-2 bg-[#772583] text-white rounded-md text-sm font-medium hover:bg-[#5a1c62] transition-colors duration-200"
        >
