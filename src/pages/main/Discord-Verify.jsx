...
export default function DiscordVerify() {
    ...
    return (
      <div className="min-h-screen flex flex-col bg-gray-50">
        <div className="flex-1 flex items-center justify-center">
          <div className="max-w-md w-full bg-white rounded-md shadow-sm p-8 text-center">
            <div className="mb-6">
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <div className="flex-1 flex items-center justify-center">
        <div className="max-w-md w-full bg-white rounded-md shadow-sm p-8">
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              className={`w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200 ${
                captchaToken && !isVerifying
                  ? "bg-[#96529a] hover:bg-[#772583] hover:cursor-pointer"
