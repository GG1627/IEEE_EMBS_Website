        ...
        <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-md">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">
              This login link is invalid or has expired. You'll be redirected to
              the login page.
            </p>
            <button
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-md">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">
            Welcome back to UF EMBS! Click the button below to securely log into
            your account.
          </p>
          <button
          ...
          <p className="text-xs text-gray-500">
            This will securely verify your identity and log you into your
            account.
          </p>
        </div>
      </div>
