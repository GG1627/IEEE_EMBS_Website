export const careerFields = [
  {
    ...
    classes: [
      ...
      "BME6353 - Patient Dosimetry in Medical Imaging and Radiotherapy",
  ...
  },
  {
    ...
    classes: [
      ...
      "EEL4750/EEE 5502 - Foundations of Digital Signal Processing",
      "EEE4511 - Real-time DSP Applications",
      "EEL3008 - Physics of EE",
  ...
  },
  {
    ...
    classes: [
      ...
      "EEL5934 - Micro and Nanotechnologies for Medicine, Biology, and Agriculture",
    ],
    projectIdeas: [
  ...
  },
  {
    ...
    classes: [
      ...
      "PHY4905 - Machine Learning",
      "EEE4773/5840 - Fundamentals of Machine Learning",
      "EEL5934 - Applied Machine Learning Systems",
      "EGN5216 - EGN5216 Machine Learning for AI Systems",
  ...
  },
  {
    ...
    classes: [
      "HSC4064 - Wearable Technology, Robotics, and Artificial Intelligence for Health",
      "BME6938 - Special Topics in Biomedical Engineering: Neuromechanics",
    ],
    projectIdeas: [
  ...
  },
  {
    ...
    classes: [
      ...
      "ABE5646 - Simulation of Agricultural & Biological Systems",
    ],
    projectIdeas: [
  ...
  },
  {
    ...
    companies: ["Ixana"],
    skills: ["N/A"],
    classes: ["CIS4930/CIS6930 - Cyber-Physical Systems Security"],
    projectIdeas: [
  ...
  },
  {
    ...
    classes: [
      ...
      "EEL5934 - Micro and Nanotechnologies for Medicine, Biology, and Agriculture",
      "EEL5934 - Fabrication of Micro/Nano Devices and Systems",
      "EEL6935 - Micro and Nanotechnologies for Medical Devices and Biological Science",
      ...
      "EEE4329/5400 - Future of Microelectronics Circuits",
    ],
    projectIdeas: [
